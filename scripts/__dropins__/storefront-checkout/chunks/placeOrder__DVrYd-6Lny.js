import{M as f,f as w,F as C,e as v,U as S}from"./transform-shipping-methods__Cf4nSDpLmb.js";import{g as I,t as O}from"./transform-cart__DgY4t0oRSz.js";import{f as y,j as x,P as d}from"./countries__kOBkhT14HN.js";import{events as m}from"@dropins/tools/event-bus.js";import{I as T}from"./cart-item__CslQ7p973r.js";const X=async t=>{if(!t)throw new f;return await w({type:"query",query:I,options:{method:"POST",cache:"no-cache",variables:{cartId:t}},path:"cart",signalType:"cart",transformer:O})},E=`
...
//# sourceMappingURL=placeOrder__DVrYd-6Lny.js.map
