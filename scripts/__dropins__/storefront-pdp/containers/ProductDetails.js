...
var ProductDetails = function ProductDetails(_ref) {
  var _data$attributes, _data$shortDescriptio, _data$description, _data$images$map, _data$images, _data$prices, _data$images$map2, _data$images2;
  var sku = _ref.sku,
    hideSku = _ref.hideSku,
    ...
    return ProductDetails_regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return _context.abrupt("return", (0,getRefinedProduct/* getRefinedProduct */.R)(sku, defaultSelections, optionsConfig === null || optionsConfig === void 0 ? void 0 : optionsConfig.anchorOptions));
        case 4:
          return _context.abrupt("return", (0,getProductData/* getProductData */.b)(sku));
        case 5:
        case "end":
          return _context.stop();
      }
